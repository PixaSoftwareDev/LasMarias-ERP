...
import { ChevronRight, Package, Users, Milk, Snowflake, Tags, SlidersHorizontal, DollarSign, type LucideIcon } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {/* Cotización del día (dólar/euro en pesos). */}
        <Link href="/admin/cotizacion" className="group block">
          <Card className="h-full transition-all hover:border-primary-300 hover:shadow-md">
            <CardContent className="flex h-full flex-col gap-3 pt-6">
              <div className="flex items-start justify-between gap-3">
                <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-primary-50 text-primary-700">
              ...
              <div>
                <p className="text-[11px] uppercase tracking-wide text-foreground-muted">Cotización del día</p>
                <span className="mt-1 block font-display text-2xl font-bold tracking-tight text-foreground">Dólar y euro</span>
              </div>
              <p className="mt-auto text-sm text-foreground-muted">Valor del dólar y el euro en pesos, para precios en moneda extranjera.</p>
            </CardContent>
          </Card>
        </Link>
      </div>
